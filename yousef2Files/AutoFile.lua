...
Dev_Ali(msg.chat_id_,msg.id_, 1, "⌁︙تم تفعيل جلب نسخة القروبات التلقائيه\n⌁︙سيتم ارسال نسخه تلقائيه للقروبات كل يوم الى خاص المطور الاساسي", 1, 'md')
...
Dev_Ali(msg.chat_id_,msg.id_, 1, "⌁︙تم تعطيل جلب نسخة القروبات التلقائيه", 1, 'md')
...
local curl = 'curl "' .. ALLII .. '" -F "chat_id='..DevId..'" -F "document=@'..ReLaX..'.json' .. '" -F "caption=⌁︙نسخه تلقائيه تحتوي على ↫ '..#list..' مجموعة"'
io.popen(curl)
