...
if DevAli:get(yousef2.."Ali:TagAdmins:Time"..msg.chat_id_..':'..msg.sender_user_id_) then  
Dev_Ali(msg.chat_id_, msg.id_, 1, '⌁︙انتظر دقيقة بعد ارسال الامر', 1, 'md')
return false  
end
DevAli:setex(yousef2..'Ali:TagAdmins:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
